...
void sdl_mouse_read(lv_indev_drv_t * indev_drv, lv_indev_data_t * data)
{
    ...
    data->point.x = last_x/2;
    data->point.y = last_y/2;
...
static void window_create(monitor_t * m)
{
    ...
    m->window = SDL_CreateWindow("TFT Simulator",
                              ...
                              SDL_HOR_RES * SDL_ZOOM, SDL_VER_RES * SDL_ZOOM, SDL_WINDOW_FULLSCREEN);       /*last param. SDL_WINDOW_BORDERLESS to hide borders*/
