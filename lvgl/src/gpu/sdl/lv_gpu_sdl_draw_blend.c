                    ...
                    lv_opa_t * mask, lv_draw_mask_res_t mask_res, lv_opa_t opa, lv_blend_mode_t mode)
{
    ...
    if(mask) {
        ...
        SDL_SetTextureColorMod(texture, color.ch.red, color.ch.green_l, color.ch.blue);
        ...
        SDL_SetRenderDrawColor(renderer, color.ch.red, color.ch.green_l, color.ch.blue, opa);
