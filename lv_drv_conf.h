...
#define LV_DRV_DISP_CMD_DATA(val)  digitalWrite(23, val)/*pin_x_set(val)*/    /*Set the command/data pin to 'val'*/
#define LV_DRV_DISP_RST(val)       digitalWrite(24, val)/*pin_x_set(val)*/    /*Set the reset pin to 'val'*/

/*---------
 *  SPI
 *---------*/
#define LV_DRV_DISP_SPI_CS(val)          /*spi_cs_set(val)*/     /*Set the SPI's Chip select to 'val'*/
#define LV_DRV_DISP_SPI_WR_BYTE(data)   wiringPiSPIDataRW(0, &data, 1) /*spi_wr(data)*/        /*Write a byte the SPI bus*/
#define LV_DRV_DISP_SPI_WR_ARRAY(adr, n) wiringPiSPIDataRW(0, data, n)/*spi_wr_mem(adr, n)*/  /*Write 'n' bytes to SPI bus from 'adr'*/
/*
void spi_write(void* adr, uint8_t len) {
...
#define LV_DRV_INDEV_IRQ_READ    digitalRead(19) /*pn_x_read()*/      /*Read the IRQ pin*/

/*---------
 *  SPI
 *---------*/
#define LV_DRV_INDEV_SPI_CS(val)            digitalWrite(17, val)/*spi_cs_set(val)*/     /*Set the SPI's Chip select to 'val'*/
//#define LV_DRV_INDEV_SPI_XCHG_BYTE(data)   xpttouch(data) /*spi_xchg(val)*/     /*Write 'val' to SPI and give the read value*/
#define LV_DRV_INDEV_SPI_XCHG_BYTE(data)   xpttouch(data) /*spi_xchg(val)*/     /*Write 'val' to SPI and give the read value*/
